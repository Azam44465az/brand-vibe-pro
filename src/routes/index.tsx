    ...
    <section id="contact" className="px-6 py-24">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-ink p-12 text-center text-white md:p-20">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <button onClick={onOpenChooser} className="group inline-flex items-center gap-2 rounded-full bg-accent-brand px-7 py-3.5 text-base font-semibold text-ink hover:bg-white transition-all">
