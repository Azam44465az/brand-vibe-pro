...
const hire = () => openBookingModal({ platform: "Instagram" });
    ...
    <div className="sticky top-4 z-50 flex justify-center px-4">
      <nav className="flex w-full max-w-6xl items-center justify-between rounded-full border border-border bg-white/90 px-6 py-3 text-ink shadow-[0_4px_24px_rgba(20,20,60,0.08)] backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={hire} className="rounded-full bg-brand-blue px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-blue-dark transition-colors">
            Hire an editor
          </button>
        </div>
      </nav>
    ...
    <section className="relative overflow-hidden pt-16 pb-20">
      ...
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <button onClick={hire} className="group inline-flex items-center gap-2 rounded-full bg-brand-blue px-7 py-3.5 text-base font-semibold text-white shadow-[0_8px_0_0_var(--brand-blue-dark)] hover:translate-y-0.5 hover:shadow-[0_4px_0_0_var(--brand-blue-dark)] transition-all">
            Hire an editor
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            A collaboration workspace built for Instagram editors and your team.
          </p>
        </div>
    ...
    <section id="how" className="py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-display mt-5 text-4xl font-extrabold text-ink md:text-6xl">
            From brief to <span className="relative inline-block"><span aria-hidden className="absolute inset-x-[-0.15em] top-[0.15em] bottom-[-0.05em] bg-brand-pink rounded-sm" /><span className="relative">banger</span></span> in 3 steps
          </h2>
        </div>
