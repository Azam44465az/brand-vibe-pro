...
export const POSTS: BlogPost[] = [
  {
    ...
    category: "Hiring",
    author: "Sana Malik",
    authorRole: "Head of Talent, Reelhire",
    date: "Jul 22, 2026",
    readTime: "8 min read",
    cover:
    ...
    content: [
      ...
      { type: "p", text: "Once you've picked an editor, set up a shared Frame.io or Reelhire workspace, a single Notion doc with brand rules, and a recurring 15-minute Monday sync. That's it. Over-structured onboarding is where most creator-editor relationships die in the first month." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Telling an editor 'make it punchy' means nothing. Linking two reels and saying 'this energy, this pacing, but with our brand tone' means everything. Every Reelhire brief has a 'reference wall' section — it's the fastest shortcut to a first cut that lands." },
  ...
  },
  {
    ...
    category: "Strategy",
    author: "Daniel Osei",
    authorRole: "Co-founder, Reelhire",
    date: "Jun 30, 2026",
    readTime: "9 min read",
    cover:
    ...
    content: [
      { type: "p", text: "Every brand asks the same question at some point: do we hire an editor in-house, keep juggling freelancers, or move to a service like Reelhire? There's no universal right answer — but there are honest tradeoffs." },
      ...
      { type: "p", text: "A dedicated editor plus a managed workflow (like Reelhire) sits between the two. You pay a flat monthly fee, keep the same editor month over month, and get built-in coverage when they're out. Ceiling is lower than a great in-house hire, but the floor is much higher than freelancing." },
